def console():
    ...
    print("5. Exit")
    option = int(
        input("Please select any one of the above options to proceed: "))
    calculator(option)
...
def calculator(option):
    if(option == 1):
        ...
        val = int(input(
            "Please enter 1 to find the palindrome for a number or 2 to find the palindrome for a string: "))
        if(val == 1):
        ...
        num = int(
            input("Please enter a number to find the fibonacci series of it: "))
        fibonacci(num)
    elif(option == 4):
        num = int(input(
            "Please enter a number of which you want to print the multiplication tables: "))
        range = int(input(
            "Please enter the range upto which you want to print the multiplication tables: "))
        tables(num, range)
    elif(option == 5):
        print("Thank you.!")
        exit()
